...
const SendMoneySuccessful = () => {
  ...
  const { recepientName } = route.params as { recepientName: string };
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <Image
        source={
          dark
            ? illustrations.successPaymentTypeDark
            : illustrations.successPaymentType
        }
        contentFit="contain"
      ...
      <View>
        ...
        >
          {amount} NGN has been successfully sent to{' '}
        </Text>
        <Text
          style={[
            styles.subtitle,
