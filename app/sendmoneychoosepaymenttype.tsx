      ...
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.view}>
            ...
            >
              We will save this for all payments to Christian Dawson. You can
              change this on the review screen.
            </Text>
          </View>
          <View
            style={[
          ...
          <View>
            ...
            >
              ...
              <Image
                source={
                  dark ? illustrations.servicesDark : illustrations.services
                }
                contentFit="cover"
              ...
              <View style={styles.viewContainer}>
                ...
                >
                  Get a full refund if an eligible item gets lost or damaged.
            ...
            >
              ...
              <Image
                source={
                  dark ? illustrations.friendsDark : illustrations.friends
                }
                contentFit="cover"
                style={styles.paymentImage}
              />
